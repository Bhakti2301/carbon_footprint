...
class CarbonTrackerViewProvider {
...
CarbonTrackerViewProvider.viewType = 'carbonTrackerView';
function activate(context) {
    const provider = new CarbonTrackerViewProvider(context.extensionUri);
    context.subscriptions.push(vscode.window.registerWebviewViewProvider(CarbonTrackerViewProvider.viewType, provider));
